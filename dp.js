...
server.on("message", function (msg, rinfo) {
	...
	/**********************Modified***********************/	
	var dnsRequestType,additional;
	
	additional=clientReq.substr(clientReq.length - 110, 4);
	console.log("Additional: "+additional);
	if(parseInt(additional)==1)
		dnsRequestType=clientReq.substr(clientReq.length - 54, 4);
	else 
		dnsRequestType=clientReq.substr(clientReq.length - 8, 4);
	console.log("Type: "+dnsRequestType);
	...
	if(dnsRequestType === "0001" || dnsRequestType === "001c") 
	{
		...
		else {dnsPacketInHexWithoutTransactionId
